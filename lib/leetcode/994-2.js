...
var orangesRotting = function (grid) {
    ...
    var fresh = {}; // 新鲜集合
    var rotten = {}; // 腐烂集合
    var genKey = function (x, y) { return String(x) + ',' + String(y); };
    ...
    while (Object.keys(fresh).length) {
        ...
        // 遍历腐烂的橘子，腐烂它周边的新鲜的橘子
        Object.keys(rotten).forEach(function (key) {
            var _a = __read(rotten[key], 2), rowNum = _a[0], colNum = _a[1];
            var list = [
                [rowNum - 1, colNum],
                [rowNum + 1, colNum],
                [rowNum, colNum - 1],
            ...
            list.forEach(function (_a) {
                var _b = __read(_a, 2), rowNum = _b[0], colNum = _b[1];
                var _key = genKey(rowNum, colNum);
